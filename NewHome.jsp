...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="NewHome.jsp">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item" >
		<a   style="color: orange; title:ViewCart;" class="nav-link active" href="NewFile.jsp">ViewCart</a>
        </li>
		...
		<li class="position-absolute top-5 end-0">
	        <div class="dropdown">
			 ...
			 <ul class="dropdown-menu mx-5">
			   <li><a class="dropdown-item" href="NewFile.jsp">
			   <img alt="img1" src="MyPhotos/shopping_cart_black_24dp.svg" width="20" height="20">
			   ViewCart</a></li>
...
<div class="container-fluid column pt-3">
 <h2 class="text-center">New Arrivals</h2>
  <div class="container-fluid w50 textbox-1" style="padding:5px 10px 5px 10px;">
