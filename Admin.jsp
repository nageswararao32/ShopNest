  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a   style="color: orange;"    class="nav-link active" aria-current="page" href="NewHome.jsp">
          Home
          </a>
        </li>
        <li class="nav-item" >
		<a class="nav-link active" style="color: orange;" href="FetchingUserInformation.jsp" aria-current="page">View User Information</a>
        </li>
        <li class="nav-item">
        <a class="nav-link active" style="color: orange;" href="AddProducts.jsp" aria-current="page">Add Product Information</a>
        </li>
        <li class="nav-item">
        <a class="nav-link active" style="color: orange;" href="FetchingProductInfo.jsp" aria-current="page">View Product Information</a>
        </li>
        <li class="position-absolute top-5 end-0">
	        <div class="dropdown">
			 <button type="button" class="btn btn-primary dropdown-toggle mx-5" data-bs-toggle="dropdown">
			   <img src="MyPhotos/Profile.svg" class="avatar" alt="Avatar" style="width:40px; height:40px;"><%= Usname %>										
			 </button>
			 <ul class="dropdown-menu mx-5">
			   ...
			   <img alt="img1" src="MyPhotos/logout_black_24dp.svg" width="20" height="20">
			   Logout</a></li>
			 </ul>
			</div>
		</li>
