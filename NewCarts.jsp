			...
			<h6 class="text-center">Price: &#8377;<%= prodArr[3]%></h6>
				...
				<h6 class="text-center p-2"><span class="badge bg-success">4.4 <ion-icon name="star-half-outline"></ion-icon></span></h6>
					...
					<div class="btn-group d-flex">
						<a  class="btn btn-warning flex-fill" href="addServlet?productId=<%=Integer.parseInt(prodArr[0])%>">ADDTOCART</a><a target="_blank" class="btn btn-success flex-fill" href="login.jsp">BUYNOW</a>
					</div>
					</form>
					</div>
