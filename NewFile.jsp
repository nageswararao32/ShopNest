...
<section class="container sproduct my-5 pt-5">
	<div class="row mt-5">
		...
		<img class="card p-2 img-fluid" alt="Prod1" src="MyPhotos/<%= p.getPimg()%>" style="height:300px; width:300px;">
		</div>
			<div class=" col-lg-6 col-md-12 col-12">
			<h1 style="color:SlateBlue;"><%=p.getPname() %></h1>
			<h3>Price: &#8377;<%=p.getPprice() %></h3>
			<h6>Discount:&nbsp;(50% off)</h6>
			<h6>Rating: <span class="badge bg-success">4.4 <span class="fa fa-star"></span></span></h6>
			<h4>Quantity:
			<input type="number" value="1" style="width:200px;" name="Number"/>
			</h4>
			<p> <h6>Description:</h6>
				<%= p.getPdesc() %>
			</p>
			<a class="btn btn-primary mt-auto justify-content-center" href="now?productId=<%=p.getPid()%>" target="_blank" >
		BUYNOW
		</a>
			</div>
	...
	<h1  class="text-center bg-info"style="color:orange;">Totall Bill:<%= subTotal %></h1>
